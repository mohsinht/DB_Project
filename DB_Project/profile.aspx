<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="profile.aspx.cs" Inherits="DB_Project.profile" %>
...
<div class="text-center mb-4">
      ...
      <div class="form-label-group">
        ...
        <asp:Button  CssClass="btn btn-lg btn-primary btn-block" runat="server" ID="registerButtonp" Text="Sign Up"/>
